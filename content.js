...
const contentData = [
    // === PUBLICATIONS ===
    {
        id: 'GIs-paper', // Must be unique for publications
        type: 'publication',
        ...
        `},
    {
        ...
        date: '2026', // Just the year is fine for publications
        link: 'https://www.cell.com/current-biology/fulltext/S0960-9822(26)00249-6', // Link to the paper (PDF, DOI, or a page)
        abstract: `
...
* How these viruses may be influencing the chemistry of the pools.
    ...
    // === Teaching ===
    {
        ...
        type: 'teaching',
        title: 'Lesson 1:Protein Prediction',
        date: '2025-06-24',
    ...
    },
    {
        id: 'introduction',
        type: 'teaching',
        title: 'Introduction (Read First)',
        date: '2025-010-24',
        description: 'An introduction to using these tutorials.',
        markdownUrl: 'teaching/introduction.md'
    },
    // === INTERACTIVE PAGES ===
    {
